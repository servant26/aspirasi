...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <img src="{{ asset('dist/img/AdminLTELogo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Aspirasi Masyarakat</span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="#">Ali Khatami</a>.</strong> All rights reserved.
  </footer>
...
<script>
  $(function () {
    $("#example1").DataTable({
      "responsive": true, 
      "lengthChange": false, // Menonaktifkan pilihan jumlah baris per halaman di UI
      "autoWidth": false,
      "buttons": ["copy", "csv", "excel", "pdf", "print", "colvis"],
      "pageLength": 5 // Membatasi 5 baris per halaman
